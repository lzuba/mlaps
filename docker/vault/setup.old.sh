...
if [ ! -f "/shared/INITIALIZED" ]; then
    ...
    #mysql -u dev -h db -pdev dev -e "insert into Password (id, machine_id, password, status, password_set, password_received, password_expiry) values (d2de2708-c27c-11ed-8b81-4b498eb56a2e,81a70234-c27b-11ed-a0f5-fb79d6671c6e,'MyEncryptedPassword1','Testing',True,2020-01-01 12:24:24.242424,2020-01-01 12:36:36.363636);"
    ...
    #mysql -u dev -h db -pdev dev -e "insert into Password (id, machine_id, password, status, password_set, password_received, password_expiry) values (e8359956-c27c-11ed-afb3-c3922f844a02,91a5de62-c27b-11ed-b06e-73a6e07e676e,'MyEncryptedPassword3','Testing',True,2020-01-01 13:26:26.262626,2020-01-01 13:39:39.393939);"
    ...
    #mysql -u dev -h db -pdev dev -e "insert into Password (id, machine_id, password, status, password_set, password_received, password_expiry) values (f5b92d0e-c27c-11ed-8728-77b6c3364352,a0bae91a-c27b-11ed-97d2-efbae491e385,'MyEncryptedPassword5','Testing',True,2020-01-01 14:28:28.282828,2020-01-01 14:42:42.424242);"
